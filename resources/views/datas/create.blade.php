                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <input type="text" name="kuantitas" id="kuantitas" type="text"
                            ...
                            <div class="px-4 py-1 bg-white sm:p-6">
                                <label for="harga" class="block font-medium text-sm text-gray-700">Harga per
                                    unit</label>
                                <input type="text" name="harga" id="harga" type="text"
                                       class="form-input rounded-md shadow-sm mt-1 block"
                                       value="{{ old('harga', '') }}"/>
                                @error('harga')
                                <p class="text-sm text-red-600">{{ $message }}</p>
