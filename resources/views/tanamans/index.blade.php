                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('tanamans.show', $tanaman->id) }}" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">View</a>
...
<div class="tab-content ml-4 mb-4" id="nav-tabContent">
    ...
    <!-- Umbi - umbian -->
    <div class="tab-pane fade" id="nav-umbi" role="tabpanel" aria-labelledby="nav-umbi-tab">
        <div class="text text-black mt-4">
            <h4>Umbi - umbian</h4> <br>
            <b>Kentang</b> <br>
            Syarat : <br>
            <div class="ml-5">
                - Tumbuh sempurna di dataran tinggi, berkisar antara 1.600 hingga 3.000 meter di atas permukaan laut. <br>
                - Kelembapan udara antara 80% hingga 90% <br>
                - Curah hujan berkisar antara 1200 hingga 1500 mm/th <br>
                - PH tanah netral berkisar 5 hingga 6, 5. Jika terlalu asam (kurang dai 5) lakukan pengapuran. Sebaliknya <br>
                jika tanah terlalu basa (lebih dari 9) berikan belerang sebelum penanaman. <br>
            ...
            3. Buatlah bedengan dengan tinggi 30 cm, dan lebar 70 cam menghadap ke timur-barat agar mendapat pasokan sinar <br>
            ...
            6. Selanjutnya tanamlah umbi kentang yang telah bertunas kurang lebih 2 cm, kemudian tutup kembali dengan tanah <br>
            setebal 5 cm. <br>
            <br>
            Cara pemupukan : <br>
            Pemupukan rutin setiap 20 hari sekali sejak masa tanam dengan dosis: <br>
            <div class="ml-5">
            ...
            <br>
            Penyiangan: <br>
            Fase berikutnya penyianagn dapat dlakukan berbarengan dengan pemupukan. Atau dapat juga dimulai setelah usia <br>
            tanam menginjak umur 30 hari dan kemudian pada umur 50 hari. <br>
            <br>
            Penyiraman: <br>
            Siram pada tanah yang terlihat kering. Terlalu banyak air akan menghentikan pertumbuhan umbi kentang. Pentiraman <br>
            dapat dilakukan seminggu sekali tanpa membuat lahan terlalu basah tergenang air. <br>
            <br>
            Masa Panen: <br>
            Tanaman kentang umumnya dapat dipanen pada usia 3 sampa 4 bulan setelah masa tanam. Lakukanlah panen kentang <br>
            pada waktu cuaca cerah. Memanen pada saat hujan akan membuat kentang cepat membusuk <br>
