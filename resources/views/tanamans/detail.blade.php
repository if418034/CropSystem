    ...
    <div class="container-fluid">
                        ...
                        <div class="col mr-2">
                            @foreach($date as $dates)
                                @if($dates ->pembibitan <= $today && $today < $dates ->panen )
                                    ...
                                    <div
                                        class="h5 mb-0 font-weight-bold text-gray-800">{{(strtotime($today)-strtotime($dates->pembibitan))/ 86400}}
                                        Hari
                                    </div>
                                @endif
                            @endforeach
        ...
        <nav>
            <div class="nav nav-tabs ml-4" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-kategori-tab" data-toggle="tab" href="#nav-kategori" role="tab"
                   aria-controls="nav-kategori" aria-selected="false">Cara Penanaman</a>
            </div>
        </nav>
                ...
                <!-- Kacang-kacangan -->
                    <div class="tab-pane fade show active" id="nav-kategori" role="tabpanel"
                        ...
                        <div class="text text-black mt-4">
                            ...
                            Syarat : <br>
                            <div class="ml-5">- Suhu udara yang disarankan adalah 28-32 derajat celcius dan kelembaban
                                udara 65
                                hingga 75 persen. <br>
                                - Curah hujan yang disarankan adalah 800 hingga 1.300. <br>
                                - Kacang tanah cocok dengan tanah yang memiliki keasaman sekitar 5 sampai 6,3 pH. <br>
                            </div>
                            <br>
                            <b>Cara penanaman : </b> <br>
                            <div class="ml-5">
                                1. Tanah digemburkan terlebih dahulu sampai butiran kecil-kecil. Lalu tambahkan dolomit
                                atau kapur
                                pertanian <br>
                                ...
                                ditugal
                                dengan <br>
                                jarak 25 x 25 cm. Setiap lubang diisi satu benih biji. Kemudian padatkan dengan tanah.
                                <br>
                            ...
                            <div class="ml-5">
                                ...
                                - Hasil dari penyerbukan dan pembuahan biasanya akan tumbuh ginofor yang menuju ke tanah
                                dan
                                menembus ke <br>
                                ...
                                yang
                                muncul. <br>
                                Bila ada serangan penyakit, segera cabut tanaman kacang tanah yang terserang penyakit.
                                Lalu masukkan
                                <br>
                                dalam kantong dan dibakar. Ini merupakan salah satu upaya mencegah penyebaran penyakit
                                ke tanaman
                                yang lain. <br>
                                - Untuk meningkatkan buah bagus, disarankan melakukan penyiangan dan pembubunan tanah
                                pada bagian
                                <br>
                                bawah tanaman.
                            </div>
                    ...
                    <div class="tab-pane fade" id="nav-kategori" role="tabpanel" aria-labelledby="nav-kategori-tab">
                        <div class="text text-black mt-4">
                            ...
                            <div class="ml-5">
                                ...
                                - Tanaman semangka akan tumbuh baik di dataran rendah ataupun dataran tinggi dengan
                                kisaran antara 0
                                – 1000 <br>
                            ...
                            tersebut. <br>
                            <br>
                            Lakukan proses perendaman benih semangka terlebih dahulu dengan Pupuk Organik Cair GDM
                            Spesialis
                            Buah-buahan <br>
                            sebanyak 30 ml dicampur dengan 1 liter air hangat dan direndam selama 4-5 jam. Kemudian
                            ditiriskan dan
                            diperas <br>
                            dengan kain basah atau kertas koran. Setelah 2-3 hari benih semangka akan mulai berkecambah
                            dan siap
                            dipindah <br>
                            pada media semai. <br>
                            <br>
                            ...
                            <div class="ml-5">
                                ...
                                5. Pastikan langkah diatas dulur-dulur lakukan dengan benar dan baik, agar benih
                                semangka dapat
                                tumbuh optimal <br>
                                dan baik. <br>
                            </div>
                            ...
                            Lakukan penyiraman tanaman semangka setiap 3 hari sekali atau dapat disesuaikan dengan
                            kondisi cuaca
                            ataupun <br>
                            lingkungan setempat. <br>
                            Namun pada awal pembentukan bunga sebaiknya jangan disiram, lakukan penyiraman kembali saat
                            buah
                            semangka <br>
                            mulai terbentuk. <br>
                            ...
                            <br>
                            Hal ini bertujuan agar selama budidaya semangka proses penyerapan unsur hara dapat terfokus
                            pada cabang
                            yang <br>
                            dipelihara saja. <br>
                            <br>
                            ...
                            tanaman semangka <br>
                            secara maksimal. <br>
                            Penyiangan dapat dilakukan sehari 2 kali atau dapat disesuaikan kebutuhan tanaman semangka
                            <br>
                            <br>
                            Buang Buah Yang Tidak Normal <br>
                            Pada umunya buah semangka yang dapat tumbuh dengan baik pada tanaman semangka hanya
                            berjumlah 2-3 buah
                            saja. <br>
                            Maka dari itu buah semangka yang tidak normal pada daun pertama sampai ke 13 harus dibuang
                            dan buah
                            semangka yang <br>
                            ...
                            Jika serangan hama berada diatas ambang batas ekonomi kendalikan dengan insektisida dan jika
                            ada
                            ...
                            Saat semangka memasuki masa panen, tentu dulur mengetahui karakteristik buah semangka yang
                            siap dipanen
                            <br>
                ...
                <!-- Daun-daunan -->
                    <div class="tab-pane fade" id="nav-kategori" role="tabpanel" aria-labelledby="nav-kategori-tab">
                        <div class="text text-black mt-4">
                            ...
                            Waktu tanam untuk tanaman jenis daun-daunan yang terbaik adalah pada awal musim hujan antara
                            bulan Oktober–Nopember
                            atau pada awal musim kemarau antara bulan Maret–April. <br>
                            <div class="text text-gray-600">
                                <small>Syarat: Daun-daunan sebaiknya ditanam pada tanah yang gembur dan cukup subur
                                    dengan
                                    kisaran pH
                                    6-7.</small> <br>
                            </div>
                            ...
                            <div class="ml-5">
                                Lahan untuk pertanaman daun-daunan perlu diolah lebih dahulu dengan dicangkul sedalam
                                20–30 cm
                                supaya <br>
                            </div>
                            gembur. Setelah itu dibuat bedengan dengan arah membujur dari Barat ke Timur, untuk
                            mendapatkan cahaya
                            penuh. <br>
                            Lebar bedengan 1 m, sedangkan panjang bedengan dapat dibuat tergantung ukuran/bentuk lahan.
                            Setelah <br>
                            diratakan, bedengan diberi pupuk kandang kuda atau ayam dengan dosis 10 ton/ha atau 1 kg/10
                            m2 bila <br>
                            kondisi tanahnya kurang subur (kandungan bahan organiknya rendah). Lahan yang kaya bahan
                            organik <br>
                            tidak perlu diberikan pupuk kandang lagi. Selanjutnya, pupuk buatan diberikan dengan dosis N
                            120 kg,
                            <br>
                            P2O5 90 kg dan K2O 50 kg per hektar atau setara dengan Urea 30 g, TSP 20 g dan KCl 10 g tiap
                            m2 luas
                            <br>
                            bedengan. Pupuk tersebut disebar rata dan diaduk pada bedengan, kemudian permukaannya
                            diratakan. <br>
                            Penanaman benih daun-daunan dapat dilakukan dengan tiga cara, yaitu menyebar biji langsung
                            pada
                            bedengan, <br>
                            menyebar langsung pada larikan/barisan, dan melalui persemaian lebih dahulu. <br>
                            <br>
                            <div class="ml-5">
                                • Biji disebar langsung secara merata di atas permukaan bedengan kemudian ditutup tipis
                                dengan tanah
                                (tebalnya <br>
                                ...
                                setelah tumbuh (kurang dari 10 hari), bibit dibumbun dan dipelihara selama kurang <br>
                                lebih 3 minggu sampai siap dipindah ke lapangan. Jarak tanam pada sistem ini adalah 50
                                cm x 30 cm. <br>
                            </div>
                            <br>
                            ...
                            <b>Pemeliharaan</b> <br>
                            <div class="ml-5">
                                Tanaman daun-daunan yang masih muda (sampai minggu pertama setelah tanam) memerlukan air
                                sebesar <br>
                            </div>
                            kurang lebih 4 mm/tanaman atau 4 l/m2 dalam sehari. Menjelang dewasa tanaman ini memerlukan
                            air <br>
                            sekitar 8 mm atau 8 l/m2 setiap harinya. Penyiangan rumput secara khusus pada pertanaman
                            daun-daunan <br>
                            petik tidak terlalu diperlukan. <br>
                            <br>
                            <b>Pengendalian Organisme Pengganggu Tumbuhan (OPT)</b> <br>
                            <div class="ml-5">
                                Jenis hama yang sering menyerang tanaman daun-daunan diantaranya ulat daun, kutu daun,
                                pengorok daun <br>
                            </div>
                            dan belalang. Jika terpaksa harus menggunakan insektisida, gunakan jenis insektisida yang
                            aman <br>
                            ...
                            <div class="ml-5">
                                Bayam cabut biasanya dipanen apabila tingginya sudah mencapai kira–kira 20 cm, yaitu
                                pada umur <br>
                            </div>
                            antara tiga sampai empat minggu setelah tanaman tumbuh. Tanaman ini dapat dicabut dengan
                            akarnya <br>
                            atau dengan cara memotong pada bagian pangkal sekitar 2 cm di atas permukaan tanah.
                            Sedangkan bayam <br>
                            petik biasanya mulai dapat dipanen pada umur antara satu sampai setengah bulan dengan
                            interval <br>
                            pemetikan seminggu sekali. Produksi tanaman bayam yang dipelihara dengan baik dapat mencapai
                            5 <br>
                            sampai 10 ton/ha. Penanganan pasca panen bayam terutama diarahkan untuk mempertahankan
                            kesegarannya,
                            <br>
                            yaitu dengan cara menempatkan bayam yang baru dipanen di tempat berair, merendam bagian
                            akarnya <br>
                            ...
                            <div class="ml-5">
                                ...
                                yang <br>
                                akan kita gunakan. Akan tetapi jika lokasi tanah kita tinggi tidak menggunakan bedengan
                                juga <br>
                                tidak masalah. <br>
                                ...
                                pepohonan
                                <br>
                                yang tumbuh. Dan bebas dari daerah ternaungi, karena tanaman sawi suka pada cahaya
                                matahari secara
                                <br>
                                langsung. <br>
                                ...
                                - Pemberian pupuk kandang fermentasi 3 - 5 ton/ha. Pupuk kandang fermentasi diberikan
                                saat <br>
                            ...
                            terlebih <br>
                            dahulu yaitu pupuk kandang 3 – 5 ton/ha, TSP 40 kg/ha, Kcl 15 kg/ha. Sedang jarak tanam
                            dalam bedengan
                            <br>
                            ...
                            <div class="ml-5">
                                1. Penyiraman, penyiraman ini tergantung pada musim, bila musim penghujan dirasa
                                berlebih maka kita
                                <br>
                                ...
                                2. Penjarangan dilakukan 2 minggu setelah penanaman. Caranya dengan mencabut tanaman
                                yang tumbuh
                                <br>
                                terlalu rapat. <br>
                                ...
                                mudah yaitu
                                <br>
                                tanaman yang mati atau terserang hama dan penyakit diganti dengan tanaman yang baru.
                                <br>

                                4. Penyiangan biasanya dilakukan 2 – 4 kali selama masa pertanaman sawi, disesuaikan
                                dengan kondisi
                                <br>
                                keberadaan gulma pada bedeng penanaman. Biasanya penyiangan dilakukan 1 atau 2 minggu
                                setelah <br>
                                penanaman. Apabila perlu dilakukan penggemburan dan pengguludan bersamaan dengan
                                penyiangan. <br>

                                5. Pemupukan tambahan diberikan setelah 3 minggu tanam, yaitu dengan urea 20 kg/ha 1
                                minggu sekali
                                <br>
                            ...
                            lama 70 hari. Paling pendek umur 40 hari. Terlebih dahulu melihat fisik tanaman seperti
                            warna, bentuk
                            dan <br>
                            ukuran daun. Cara panen ada 2 macam yaitu mencabut seluruh tanaman beserta akarnya dan
                            dengan memotong
                            <br>
                            bagian pangkal batang yang berada di atas tanah dengan pisau tajam. Pasca panen sawi dan
                            caisim yang
                            perlu <br>
                            ...
                            iklim
                            setempat <br>
                            serta ketersediaan biaya dan tenaga kerja kita. Demikian cara teknis budidaya tanaman sawi
                            atau caisim
                            dari <br>
